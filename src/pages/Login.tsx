...
import { motion } from "framer-motion";// Updated for latest motion versions
...
import { GoogleLogin, GoogleOAuthProvider } from "@react-oauth/google"; // Added Provider
...
const Login = () => {
  ...
  const GOOGLE_CLIENT_ID = "992144760157-rvg25pmo71nn0urjlq8ph36ec7g7qsto.apps.googleusercontent.com";
  ...
  return (
    // Wrap the component content with GoogleOAuthProvider
